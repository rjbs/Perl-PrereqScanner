...
package Perl::PrereqScanner::Scanner::Inherit;
use Moose;
with 'Perl::PrereqScanner::Scanner';
# ABSTRACT: scan for modules loaded with inherit.pm

=head1 DESCRIPTION

This scanner will look for dependencies from the L<inherits> module:

    use inherit 'Foo', Bar => 1.23;
